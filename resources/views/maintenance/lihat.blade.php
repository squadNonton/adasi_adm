                                ...
                                <div class="collapse" id="updateProgress">
                                    <form enctype="multipart/form-data">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="date" class="form-control" id="due_date" name="due_date" value="{{ $latestTindakLanjut->due_date }}" disabled>
                                        </div>

                                        <div class="mb-3">
                                            <label for="schedule_pengecekan" class="form-label">Schedule Pengecekan</label>
                                            <input type="date" class="form-control" id="schedule_pengecekan" name="schedule_pengecekan" value="{{ $latestTindakLanjut->schedule_pengecekan }}" disabled>
                                        </div>


                                        <div class="mb-3">
                                            <label for="attachment_file" class="form-label">Attachment File</label><br>
