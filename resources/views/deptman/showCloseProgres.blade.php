...
@section('content')
    <main id="main" class="main">
        ...
        <div class="pagetitle">
            <h1>Halaman Riwayat Klaim dan Komplain</h1>
            <nav>
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="{{ route('dashboardHandling') }}">Dashboard</a></li>
                    <li class="breadcrumb-item"><a href="{{ route('showHistoryCLaimComplain') }}">Menu Riwayat Klaim dan Komplain</a></li>
                    <li class="breadcrumb-item active">Halaman Riwayat Klaim dan Komplain</li>
                </ol>
            </nav>
        </div><!-- End Page Title -->
